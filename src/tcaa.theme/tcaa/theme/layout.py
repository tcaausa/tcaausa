...
class TCAALayoutPolicy(LayoutPolicy):
    ...
    def have_portlets(self, manager_name, view=None):
        ...
        We customise this to never hide the left column, since our theme 
        required that it is always present.
        """

        # We only do this for the right column in the TCAA theme
        ...
        # The rest of this method is a copy of the Plone 4 default implementation
    ...
    def bodyClass(self, template, view):
        """Determine a CSS class to go on the body tag. This is useful for styling.

        We customise this to add a class when the right column is invisible.
        """

        bodyClass = super(TCAALayoutPolicy, self).bodyClass(template, view)
